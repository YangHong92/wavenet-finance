...
with open("mean_absolute_errors.txt", "w") as f:
      ...
      if 0 in run_example:
            ...
            f.write("itr_eqb_res_skip_generate: " + str(mean_absolute_error(y_discret[-test_round:], preds)) + "\n")
      ...
      if 1 in run_example:
            ...
            f.write("itr_eqb_res_skip_cond_generate: " + str(mean_absolute_error(y_discret[-test_round:], preds)) + "\n")
      ...
      if 2 in run_example:
            ...
            f.write("itr_eqb_skip_generate: " + str(mean_absolute_error(y_discret[-test_round:], preds)) + "\n")
      ...
      if 3 in run_example:
            ...
            f.write("itr_eqb_res_generate: " + str(mean_absolute_error(y_discret[-test_round:], preds)) + "\n")
      # ********* equal bin_width *********
      ...
      if 4 in run_example:
            ...
            f.write("itr_uneqb_res_skip_generate: " + str(mean_absolute_error(y_uneq_discret[-test_round:], preds)) + "\n")
      ...
      if 5 in run_example:
            ...
            f.write("itr_uneqb_res_skip_cond_generate: " + str(mean_absolute_error(y_uneq_discret[-test_round:], preds)) + "\n")
      # ********* unequal bin_width *********
